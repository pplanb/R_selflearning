...
library(magrittr)
#library(plotly)
source("D:/TradingRepos/R_selflearning/_FUN/load_data.R")
source("D:/TradingRepos/R_selflearning/_FUN/create_labelled_data.R")
source("D:/TradingRepos/R_selflearning/_FUN/create_transposed_data.R")
source("D:/TradingRepos/R_selflearning/_FUN/self_learn_ai_R.R")
source("D:/TradingRepos/R_selflearning/_FUN/test_model.R")

#absolute path to store model objects (useful when scheduling tasks)
path_model <- "D:/TradingRepos/R_selflearning/_MODELS"

#absolute path with the data (choose either MT4 directory or a '_TEST_DATA' folder)
path_data <- "D:/FxPro - Terminal3/MQL4/Files/"
#path_data <- "D:/TradingRepos/R_selflearning/_TEST_DATA/"
...
file.copy(from = file.path(path_model, "LOG", "AI_T-60.csv"), 
          to = c("D:/FxPro - Terminal1/MQL4/Files/AI_T-60.csv",
                 "D:/FxPro - Terminal2/MQL4/Files/AI_T-60.csv",
                 "D:/FxPro - Terminal3/MQL4/Files/AI_T-60.csv"),
          overwrite = TRUE) 

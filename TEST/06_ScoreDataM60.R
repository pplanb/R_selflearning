...
h2o.init(nthreads = 1)
# loading the model
# ModelC <- h2o.loadModel(path = paste0("D:/TradingRepos/R_selflearning/model/DL_Classification",
...
ModelR <- h2o.loadModel(path = paste0("D:/TradingRepos/R_selflearning/model/DL_Regression",
                                      predictor_period, "-", time_frame))
# uploading data to h2o
